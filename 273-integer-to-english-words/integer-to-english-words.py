class Solution(object):
    def numberToWords(self, num):
        ...
        # Converting digits into word form
        for i in range(n):
            digit = reverse[i]
            if i % 3 == 0:
